This **Resume** is editing on website: [Overleaf](https://www.overleaf.com/project/693f76084671582d47d1197c)

```LaTex title:"My Resume"
%------------------------
% Resume Template
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Rokibul Hassan Remon}} & Email: \href{cse19015@gmail.com}{cse19015@gmail.com}\\
  \href{https://www.linkedin.com/in/rokibul-hassan-remon/}{Portfolio:/rokibul-hassan-remon/} & Mobile:~~~+880-1788-639400 \\
  \href{https://github.com/Rokibul-Hassan-Remon}{Github: ~~/Rokibul-Hassan-Remon} \\
\end{tabular*}
...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.Sc (Engg.) in CSE;  CGPA: 3.42}{Jan 2019 - Nov 2024}
    \resumeSubHeadingListEnd
    
    \resumeSubHeadingListStart
    \resumeSubheading
      {Safiuddin Sarker Academy And College}{Gazipur, Bangladesh}
      {HSC:~Science;  GPA: 5.00}{Jan 2015 - Nov 2017}
    \resumeSubHeadingListEnd

    \resumeSubHeadingListStart
    \resumeSubheading
      {Safiuddin Sarker Academy And College}{Gazipur, Bangladesh}
      {SSC:~Science;  GPA: 5.00}{Jan 2013 - Jun 2015}
    \resumeSubHeadingListEnd
	    
\vspace{-5pt}
\section{Skills Summary}
	\resumeSubHeadingListStart
	\resumeSubItem{Languages}{~~~~~~C sherp, JAVA, C++, C, SQL}
	\resumeSubItem{Frameworks}{~~~~ASP.NET Core (MVC)}
	\resumeSubItem{Tools}{~~~~~~~~~~~~~~GIT, SQL Server, MySQL, Oracle}
