...
public class Main {
	...
	public static int TreeDiameter(TreeNode node){  
	    int recentDiameter = 0;  
	    int firstHeight = -1;  
	    int secHeight = - 1;  
	      
	    for(var eachChild : node.children){  
	       recentDiameter += TreeDiameter(eachChild);  
	    }  
	    	  
	    if(recentDiameter > firstHeight){  
	        secHeight = firstHeight;  
	        firstHeight = recentDiameter;  
	    }  
	    else if( recentDiameter > secHeight){  
	        secHeight = recentDiameter;  
	    }  
	      
	    if(secHeight + firstHeight + 2 > diameter){  
	        diameter = firstHeight + secHeight + 2;  
	    }  
	     
	    return recentDiameter+1;  
	}  
	...
	public static void main(String[] args) {  
	    ...
	    TreeDiameter(root);  
	    Println("Diameter of tree: " + diameter);  
	}
