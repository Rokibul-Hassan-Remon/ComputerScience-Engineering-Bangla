```java title:"Find the Kth leargest element of a tree"
...
public class Main {
	...
	static int  LowestBound= Integer.MIN_VALUE; ;  
	static int UpperBound;  
	
	public static int KthLargestElement(TreeNode node, int mx){  
	    for(var child : node.children){  
	       int temp = KthLargestElement(child,mx);  
	       mx = Math.max(temp,mx);  
	    }  
	...
	public static void main(String[] args) {  
	    ...
	    int value = 0;  
	    for(int i = 0; i < Kth; i++){  
	        value = KthLargestElement(root, Integer.MIN_VALUE);  
	        UpperBound = value;  
	    }  
	    	  
	    Println("");  
	    Println(Kth+"th Maximum Value :"+value);  
	}
